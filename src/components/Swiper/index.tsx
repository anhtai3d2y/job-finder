...
export default function SwiperSlide({navigation}) {
        ...
        <>
            <Swiper
                ...
                <View style={styles.slide}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => setIsKmatchPlatinumModalVisible(true)}>
                ...
                <View style={styles.slide}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => setIsSuperLikeStarModalVisible(true)}>
                        <Text
                            style={[
                                styles.textButton,
                                {color: colors.superlike},
                ...
                <View style={styles.slide}>
                    ...
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => setIsBootsItemModalVisible(true)}>
                        <Text
                            style={[styles.textButton, {color: colors.boots}]}>
                            GO TO TOP NEWS FEED
                        </Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.slide}>
                    ...
                    <TouchableOpacity
                        ...
                        <Text
                            style={[styles.textButton, {color: colors.black}]}>
                            SEE ALL PLAN
                        </Text>
                    </TouchableOpacity>
                </View>
