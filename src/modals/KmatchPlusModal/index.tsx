...
const KmatchPlusModal = ({visible, setVisible}) => {
    ...
    const handleCreatePayment = async () => {
        await addPaypal(PackageType.Role, Package.KmatchPlus);
    };
    return (
                ...
                <View style={styles.centeredView}>
                    <View style={styles.modalView}>
                        ...
                        <TouchableOpacity
                            ...
                            disabled={userProfile.role !== "Kmatch Basic"}>
...
export default KmatchPlusModal;
